class DataConfig(object):
    data_path = "/mnt/e/steering_model/steering_model/data/"
...
class TestConfig(TrainConfig):
    model_path = "/mnt/e/steering_model/submissions/final_model.hdf5"
...
class StatsConfig(object):
    data_path = "/mnt/e/steering_model/data/train/steering.csv"
